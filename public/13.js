  ...
  methods: {
    ...
    upload: function upload(files) {
      ...
      _services_factory__WEBPACK_IMPORTED_MODULE_1__["default"].user["import"](formData).then(function (response) {
        _this2.$toast.success("Ingresado con éxito");
    ...
    downloadExport: function downloadExport() {
      ...
      _services_factory__WEBPACK_IMPORTED_MODULE_1__["default"].user["export"]({
        ...
        _this3.$toast.success("Exportado con éxito");
      })["catch"](function (error) {
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        [
          _c("CInput", {
            attrs: { placeholder: "Buscar", value: _vm.value },
            on: {
              "update:value": [
                function($event) {
                  _vm.value = $event
                        ...
                        fn: function(ref) {
                          ...
                          return [
                            _c("td", [
                              _vm._v(
                                _vm._s(
                                  item.title ? item.title.name : "Sin definir"
                                )
                              )
                            ])
                          ]
