  ...
  methods: {
    ...
    downloadAttachment: function downloadAttachment(item) {
      ...
      _services_factory__WEBPACK_IMPORTED_MODULE_1__["default"].attachment.download(item.id, item.name).then(function (response) {
        ...
        _this2.$toast.success("Añadido a la cola de descargas...");
    ...
    deleteAttachment: function deleteAttachment(id, index) {
      ...
      _services_factory__WEBPACK_IMPORTED_MODULE_1__["default"].attachment["delete"](id).then(function (response) {
        ...
        _this3.$toast.success("¡Eliminado con éxito!");
      })["catch"](function (error) {
    ...
    uploadAttachment: function uploadAttachment() {
      ...
      _services_factory__WEBPACK_IMPORTED_MODULE_1__["default"].attachment.create(formData, {
        ...
        _this4.$toast.success("Archivo subido");
      })["catch"](function (error) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getSymbol: function getSymbol(id) {
      this.fetchSymbol(id);
      return "No puede acceder a este recurso";
    },
...
var render = function() {
  ...
  return _c(
    "CCard",
    [
      _c("CCardHeader", [_c("strong", [_vm._v("Archivos adjuntos")])]),
      _vm._v(" "),
      _c(
        "CCardBody",
        [
...
var render = function() {
  ...
  return _c(
    "CCard",
    [
      _c("CCardHeader", [_c("strong", [_vm._v("Documento relacionado")])]),
      _vm._v(" "),
      _c(
        "CCardBody",
        [
            ...
            [
              _vm.isOutcome
                ? _c(
                    ...
                    { attrs: { sm: "12" } },
                    [
                      _c("label", [_vm._v("Lista de documentos")]),
                      _vm._v(" "),
                      _c("treeselect", {
...
var render = function() {
  ...
  return _c(
    "CCard",
    [
      _c("CCardHeader", [_c("strong", [_vm._v("Lugar de recepción")])]),
      _vm._v(" "),
      _c(
        "CCardBody",
        [
