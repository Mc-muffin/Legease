<template>
  <CCard>
    <CCardHeader>
      <strong v-if="documentId">Información del documento</strong>
      <strong v-else>Crear documento</strong>
    </CCardHeader>
    <CCardBody>
      <CForm>
        <CRow class="form-group">
          <CCol sm="12">
            <CInput label="Número de registro" placeholder="Radicado o id" :value.sync="document.symbol" class="mb-0" />
          </CCol>
        </CRow>
        <CRow class="form-group">
          <CCol sm="6">
        ...
        <CRow class="form-group">
          <CCol sm="6">
            <CInput label="Autor" :value="document.creator.name" readonly class="mb-0" />
          </CCol>
          <CCol sm="6">
            <CInput label="ID de autor" :value="document.creator.id" readonly class="mb-0" />
          </CCol>
        </CRow>
        <CTextarea
        ...
        <CRow class="form-group">
          ...
          <CCol sm="6">
            <CInput
              :label="isIncome ? 'Fecha de recepción' : 'Fecha de expedición'"
              type="date"
        ...
        <CRow class="form-group">
          ...
          <CCol sm="6">
            <CInput label="Fecha Entrega" type="date" :value.sync="document.sign_at" class="mb-0" />
          </CCol>
        </CRow>
      </CForm>
    </CCardBody>
